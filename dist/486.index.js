...
exports.modules = {
  ...
  /***/ 9486: /***/ (
    ...
    var isFile = __webpack_require__(2131); // CONCATENATED MODULE: ./node_modules/.pnpm/formdata-node@4.4.1/node_modules/formdata-node/lib/esm/fileFromPath.js
    ...
    class FileFromPath {
      constructor(input) {
        ...
        this.name = (0, external_path_.basename)(
      ...
      async *stream() {
        const { mtimeMs } = await external_fs_.promises.stat(
          __classPrivateFieldGet(this, _FileFromPath_path, 'f')
        );
        ...
        if (this.size) {
          yield* (0, external_fs_.createReadStream)(
            __classPrivateFieldGet(this, _FileFromPath_path, 'f'),
            {
      ...
      get [((_FileFromPath_path = new WeakMap()),
      (_FileFromPath_start = new WeakMap()),
      Symbol.toStringTag)]() {
        return 'File';
      }
    }
